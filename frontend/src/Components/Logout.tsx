...
const Logout = ({ onClick }: { onClick: () => void }) => {
    return (
        ...
        >
            ...
            <div
                className="absolute right-7 transform translate-x-full opacity-0 text-white text-lg font-semibold transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100 pb-1">
                Logout
            </div>
        </button>
